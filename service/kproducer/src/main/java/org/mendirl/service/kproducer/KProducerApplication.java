...
public class KProducerApplication {
    ...
    private static final Logger log = LoggerFactory.getLogger(KProducerApplication.class);

    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(KProducerApplication.class);
