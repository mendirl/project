...
public class CubeApplication {
    ...
    private static final Logger log = LoggerFactory.getLogger(CubeApplication.class);

    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(CubeApplication.class);
        ...
        log.info("\n----------------------------------------------------------\n\t" +
                ...
                "Local: \t\t{}://localhost:{}{}/ui/index.html\n\t" +
                "External: \t{}://{}:{}{}/ui/index.html\n\t" +
                "Profile(s): \t{}\n----------------------------------------------------------",
