...
import static org.mendirl.service.content.ContentSecurityConfiguration.BASIC_AUTH_BEAN_NAME;
import static org.mendirl.service.content.ContentSecurityConfiguration.ROLE_USER;
 ...
 */
@Configuration
@Order(1) // Must be done before ContentServerSecurityConfigurer (because they match common URLs)
