...
public class CounterParty implements Serializable {
    ...
    public String toCsvString() {
        ...
        sb.append(SourceConfig.CSV_SEPARATOR).append(getCounterPartyGroup());
        sb.append(SourceConfig.CSV_SEPARATOR).append(getCity());
        sb.append(SourceConfig.CSV_SEPARATOR).append(getSector());
        sb.append(SourceConfig.CSV_SEPARATOR).append(getRating());
        return sb.toString();
    }
